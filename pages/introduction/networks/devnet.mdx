...
export const page = {
title: 'Devnet - Developer Network',
date: '18 August 2018',
authors: [lewi],
editUrl: 'pages/introduction/networks/devnet.mdx',
}
...
The Devnet is primarily comprised of servers hosted by the IOTA Foundation. The topology of the network is shown below:

<Image
src={`/static/docs/networks/devnet_layout.png`}
width={600}
height={422}
caption="Topology of the IOTA Devnet"
/>
